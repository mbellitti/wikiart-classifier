...
Wikiart-Classifier is an open-source Python-based image classifier. The idea is to teach a Neural Network to recognize the style, genres, and author of an artwork.
